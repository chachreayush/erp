...
export default function BrkReceiveList({ onSelectBill, type }: BrkReceiveListProps) {
  ...
  useEffect(() => {
    const fetchBills = async () => {
      try {
        const data = await apiGetInvoices(`brk-receive-${baseType}`);
