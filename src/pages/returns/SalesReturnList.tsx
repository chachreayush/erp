...
export default function SalesReturnList({ onSelectBill, type }: SalesReturnListProps) {
  ...
  useEffect(() => {
    const fetchBills = async () => {
      try {
        const data = await apiGetInvoices(`sales-return-${baseType}`);
  ...
  const title = type === 'modify-challan' ? 'Modify Sales Return Challans' : 'Modify Credit Notes'
